...
ROOT_URL = 'https://leandertx-energovpub.tylerhost.net/apps/selfservice/api/energov/search/search'
...
HEADERS = {
    ...
    'DNT': '1',
    'Origin': 'https://leandertx-energovpub.tylerhost.net',
    'Referer': 'https://leandertx-energovpub.tylerhost.net/Apps/SelfService',
